...
actual interface WGPUDeviceLostCallback : Callback {
	...
	interface Function : com.sun.jna.Callback {
		fun apply(reason: Int, message: io.ygdrasil.wgpu.android.WGPUStringView.ByValue, userdata: com.sun.jna.Pointer?)
	}
	actual companion object {
		actual fun allocate(allocator: MemoryAllocator, callback: WGPUDeviceLostCallback): CallbackHolder<WGPUDeviceLostCallback> {
			val callbackFunction = object : Function {
				override fun apply(reason: Int, message: io.ygdrasil.wgpu.android.WGPUStringView.ByValue, userdata: com.sun.jna.Pointer?) {
					callback.invoke(reason.toUInt(), message.let { WGPUStringView.ByValue(it) }, userdata ?: com.sun.jna.Pointer(0))
				}
			}
...
actual interface WGPUErrorCallback : Callback {
	...
	interface Function : com.sun.jna.Callback {
		fun apply(type: Int, message: io.ygdrasil.wgpu.android.WGPUStringView.ByValue, userdata: com.sun.jna.Pointer?)
	}
	actual companion object {
		actual fun allocate(allocator: MemoryAllocator, callback: WGPUErrorCallback): CallbackHolder<WGPUErrorCallback> {
			val callbackFunction = object : Function {
				override fun apply(type: Int, message: io.ygdrasil.wgpu.android.WGPUStringView.ByValue, userdata: com.sun.jna.Pointer?) {
					callback.invoke(type.toUInt(), message.let { WGPUStringView.ByValue(it) }, userdata ?: com.sun.jna.Pointer(0))
				}
			}
			return CallbackHolder(com.sun.jna.Pointer(0), callbackFunction)
		}
