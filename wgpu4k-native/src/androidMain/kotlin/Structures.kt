...
sealed class WGPUAdapterInfo(pointer: com.sun.jna.Pointer? = null) : com.sun.jna.Structure(pointer) {
	...
	override fun getFieldOrder() = listOf("vendor", "architecture", "device", "description", "backendType", "adapterType", "vendorID", "deviceID", "subgroupMinSize", "subgroupMaxSize")
...
sealed class WGPUInstanceDescriptor(pointer: com.sun.jna.Pointer? = null) : com.sun.jna.Structure(pointer) {
	...
	override fun getFieldOrder() = listOf("requiredFeatureCount", "requiredFeatures", "requiredLimits")
...
sealed class WGPUInstanceLimits(pointer: com.sun.jna.Pointer? = null) : com.sun.jna.Structure(pointer) {
	...
	override fun getFieldOrder() = listOf("timedWaitAnyMaxCount")
...
sealed class WGPUPipelineLayoutDescriptor(pointer: com.sun.jna.Pointer? = null) : com.sun.jna.Structure(pointer) {
	...
	override fun getFieldOrder() = listOf("label", "bindGroupLayoutCount", "bindGroupLayouts", "immediateSize")
...
sealed class WGPURequestAdapterOptions(pointer: com.sun.jna.Pointer? = null) : com.sun.jna.Structure(pointer) {
	...
	override fun getFieldOrder() = listOf("featureLevel", "powerPreference", "forceFallbackAdapter", "backendType", "compatibleSurface")
...
sealed class WGPUSurfaceColorManagement(pointer: com.sun.jna.Pointer? = null) : com.sun.jna.Structure(pointer) {
	...
	override fun getFieldOrder() = listOf("colorSpace", "toneMappingMode")
 ...
 * @suppress
 */
sealed class WGPUNativeDisplayHandle(pointer: com.sun.jna.Pointer? = null) : com.sun.jna.Structure(pointer) {
	@JvmField var type: Int = 0
	@JvmField var data: com.sun.jna.Pointer? = null
	override fun getFieldOrder() = listOf("type", "data")

	class ByReference(pointer: com.sun.jna.Pointer? = null) : WGPUNativeDisplayHandle(pointer), com.sun.jna.Structure.ByReference {
		constructor(other: WGPUNativeDisplayHandle) : this(other.pointer) {
			this.type = other.type
			this.data = other.data
		}
	}

	class ByValue(pointer: com.sun.jna.Pointer? = null) : WGPUNativeDisplayHandle(pointer), com.sun.jna.Structure.ByValue {
		constructor(other: WGPUNativeDisplayHandle) : this(other.pointer) {
			this.type = other.type
			this.data = other.data
		}
...
sealed class WGPUInstanceExtras(pointer: com.sun.jna.Pointer? = null) : com.sun.jna.Structure(pointer) {
	...
	@JvmField var displayHandle: WGPUNativeDisplayHandle.ByValue = WGPUNativeDisplayHandle.ByValue()
	override fun getFieldOrder() = listOf("chain", "backends", "flags", "dx12ShaderCompiler", "gles3MinorVersion", "glFenceBehaviour", "dxcPath", "dxcMaxShaderModel", "dx12PresentationSystem", "budgetForDeviceCreation", "budgetForDeviceLoss", "displayHandle")
	...
	class ByReference(pointer: com.sun.jna.Pointer? = null) : WGPUInstanceExtras(pointer), com.sun.jna.Structure.ByReference {
		constructor(other: WGPUInstanceExtras) : this(other.pointer) {
			...
			this.displayHandle = other.displayHandle
		}
	}
 ...
 * @suppress
 */
sealed class WGPULogCallbackCallbackInfo(pointer: com.sun.jna.Pointer? = null) : com.sun.jna.Structure(pointer) {
	@JvmField var nextInChain: WGPUChainedStruct.ByReference?? = null
	@JvmField var callback: com.sun.jna.Callback? = null
	@JvmField var userdata1: com.sun.jna.Pointer? = null
	@JvmField var userdata2: com.sun.jna.Pointer? = null
	...
	class ByReference(pointer: com.sun.jna.Pointer? = null) : WGPULogCallbackCallbackInfo(pointer), com.sun.jna.Structure.ByReference {
		constructor(other: WGPULogCallbackCallbackInfo) : this(other.pointer) {
			this.nextInChain = other.nextInChain
			this.callback = other.callback
			this.userdata1 = other.userdata1
			this.userdata2 = other.userdata2
	...
	class ByValue(pointer: com.sun.jna.Pointer? = null) : WGPULogCallbackCallbackInfo(pointer), com.sun.jna.Structure.ByValue {
		constructor(other: WGPULogCallbackCallbackInfo) : this(other.pointer) {
			this.nextInChain = other.nextInChain
			this.callback = other.callback
			this.userdata1 = other.userdata1
